...
<div class="primary">
  ...
  <form class="pure-form" method='post' action='' accept-charset='UTF-8'>
    ...
    <input type="text" id="gameplace" name="gameplace" value="{$game_place}" placeholder="game place" required/><br />
    <label for="gameround">Round</label><br />
    <input type="text" id="gameround" name="gameround" value="{$game_round}" placeholder="game round" required/><br />
