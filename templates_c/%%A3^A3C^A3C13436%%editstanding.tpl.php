<?php /* Smarty version 2.6.26, created on 2014-10-14 23:32:46
         compiled from editstanding.tpl */ ?>
...
?>
  ...
  <form class="pure-form pure-form-stacked" method='post' action='' accept-charset='UTF-8'>
  	 <ul class="editmenu">
		<li><a href="deletestanding.php?u_id=<?php echo $this->_tpl_vars['userLoggedIn']->getUserID(); ?>
...
">Delete</a></li>
    ...
    Team Name : <?php echo $this->_tpl_vars['team']->getName(); ?>
 </legend>
...
' <?php if ($this->_tpl_vars['user_teams']->getTeamID() == $this->_tpl_vars['team']->getTeamID()): ?>selected="selected"<?php endif; ?>><?php echo $this->_tpl_vars['user_teams']->getName(); ?>
</option>
    <?php endforeach; endif; unset($_from); ?>
    </select>
