<?php /* Smarty version 2.6.26, created on 2014-09-25 22:08:07
         compiled from insertseason.tpl */ ?>
...
?>
  ...
  <form class="pure-form pure-form-stacked" method='post' action='' accept-charset='UTF-8'>
    <h2>Insert Season for League : <?php echo $this->_tpl_vars['league']->getName(); ?>
</h2>
    
    <p>Insert a new season by filling in the following form</p>

    <p><label for="insertseasonname">Season Name</label> <input type="text" name="insertseasonname" id="insertseasonname" value="<?php echo $this->_tpl_vars['seasonname']; ?>
