<?php /* Smarty version 2.6.26, created on 2014-09-25 17:19:51
         compiled from deleteseason.tpl */ ?>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>My League Stats::Delete Season</title>
...
<div class="primary">
  ...
  <h1>Delete Season : <?php echo $this->_tpl_vars['season']->getName(); ?>
</h1>
  
  <form class="pure-form pure-form-stacked" method='post' action='' accept-charset='UTF-8'>
    
    <legend>Delete Season and all games and standings</legend>
