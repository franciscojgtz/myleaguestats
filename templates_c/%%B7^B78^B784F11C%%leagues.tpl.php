<?php /* Smarty version 2.6.26, created on 2014-10-15 23:50:48
...
?>
         <li>
         <a class="leaguelist-edit-leaguename" href="league.php?l_id=<?php echo $this->_tpl_vars['league']->getLeagueID(); ?>
"><?php echo $this->_tpl_vars['league']->getName(); ?>
</a>
         <a href="editleague.php?u_id=<?php echo $this->_tpl_vars['userLoggedIn']->getUserID(); ?>
...
" class="pure-button pure-button-primary">Edit</a>
   ...
   <p class="form-buttons"><a href="insertleague.php?u_id=<?php echo $this->_tpl_vars['userLoggedIn']->getUserID(); ?>
" class="pure-button pure-button-primary">Add a League</a></p>
