<?php /* Smarty version 2.6.26, created on 2014-10-14 23:45:25
         compiled from editgame.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'html_select_date', 'editgame.tpl', 63, false),array('function', 'html_select_time', 'editgame.tpl', 66, false),)), $this); ?>
...
?>
  ...
  <form class="pure-form" method='post' action='' accept-charset='UTF-8'>
  	 ...
  	 <ul class="editmenu">
		<li><a href="deletegame.php?u_id=<?php echo $this->_tpl_vars['userLoggedIn']->getUserID(); ?>
&&g_id=<?php echo $this->_tpl_vars['game']->getID(); ?>
">Delete</a></li>
    </ul>  
    
    <legend>Change the Game information by filling in the following form<br />
    Team Name : <?php echo $this->_tpl_vars['localTeam']->getName(); ?>
 vs <?php echo $this->_tpl_vars['visitorTeam']->getName(); ?>
</legend>
