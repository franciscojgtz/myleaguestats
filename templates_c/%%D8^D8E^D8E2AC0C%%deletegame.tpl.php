<?php /* Smarty version 2.6.26, created on 2014-10-14 23:45:27
         compiled from deletegame.tpl */ ?>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>My League Stats::Delete Game</title>
...
<div class="primary">
  ...
  <form class="pure-form pure-form-stacked" method='post' action='' accept-charset='UTF-8'>
    ...
    <legend>Deleting this game will erase all the information forever.<br />
    Team Name : <?php echo $this->_tpl_vars['localTeam']->getName(); ?>
 vs <?php echo $this->_tpl_vars['visitorTeam']->getName(); ?>
</legend>
    
    <p class="form-buttons"><input type="submit" name="submit" id="submit" value="Delete Game" class="pure-button pure-button-primary"/>
