<?php /* Smarty version 2.6.26, created on 2014-10-22 16:53:17
         compiled from season.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'cycle', 'season.tpl', 65, false),array('modifier', 'date_format', 'season.tpl', 166, false),)), $this); ?>
...
"><?php echo $this->_tpl_vars['league']->getName(); ?>
 &#8594;</a></li>
   ...
   <h3>Season Id: <?php echo $this->_tpl_vars['season']->getSeasonID(); ?>
</h3>
   <ul class="editmenu">
		<li><a href="editseason.php?u_id=<?php echo $this->_tpl_vars['userLoggedIn']->getUserID(); ?>
&&s_id=<?php echo $this->_tpl_vars['season']->getSeasonID(); ?>
">Edit</a></li>
   </ul>
...
">
            ...
            <td><a href="editstanding.php?u_id=<?php echo $this->_tpl_vars['userLoggedIn']->getUserID(); ?>
&&st_id=<?php echo $this->_tpl_vars['standing']->getStandingID(); ?>
">E</a></td>
            </tr>
      <?php endforeach; else: ?>
   ...
   <p class="form-buttons"><a href="insertstanding.php?u_id=<?php echo $this->_tpl_vars['userLoggedIn']->getUserID(); ?>
&&s_id=<?php echo $this->_tpl_vars['season']->getSeasonID(); ?>
" class="pure-button pure-button-primary">Add Team to Standings table</a></p>
   </div>
...
"><?php echo $this->_tpl_vars['game']->getVisitorTeam(); ?>
				...
				<td><a href="editgame.php?u_id=<?php echo $this->_tpl_vars['userLoggedIn']->getUserID(); ?>
&&g_id=<?php echo $this->_tpl_vars['game']->getID(); ?>
">E</a></td>
			</tr>
      ...
      <p class="form-buttons"><a href="insertgame.php?u_id=<?php echo $this->_tpl_vars['userLoggedIn']->getUserID(); ?>
&&s_id=<?php echo $this->_tpl_vars['season']->getSeasonID(); ?>
" class="pure-button pure-button-primary">Add Game</a></p>
