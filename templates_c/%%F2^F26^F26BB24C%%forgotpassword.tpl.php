<?php /* Smarty version 2.6.26, created on 2014-09-03 04:38:57
...
?>
  ...
  <form class="pure-form pure-form-stacked" method='post' action='' accept-charset='UTF-8'>
    ...
    <p><label for="memberuseremail">Email</label> <input type="email" name="memberuseremail" id="memberuseremail" value="<?php echo $this->_tpl_vars['useremail']; ?>
