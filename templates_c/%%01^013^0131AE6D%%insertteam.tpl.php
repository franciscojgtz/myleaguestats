<?php /* Smarty version 2.6.26, created on 2014-11-17 19:40:37
         compiled from insertteam.tpl */ ?>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>My League Stats::Insert Team</title>
...
?>
  ...
  <h1>Insert Team into Database</h1>
  
  <form class="pure-form pure-form-stacked" method='post' action='' accept-charset='UTF-8'>
    
    
    <legend>Add a Team by filling in the following form</legend>

    <p><label for="insertteamname">Team Name</label> <input type="text" name="insertteamname" id="insertteamname" value="<?php echo $this->_tpl_vars['teamname']; ?>
" placeholder="team name" required/> </p>
